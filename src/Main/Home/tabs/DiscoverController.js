...
const headerText =
  '分页列表支持：无网络，加载中，无数据，加载错误，加载更多等一系列状态展示';
  ...
  return (
    <View style={[CommonStyles.container, {marginTop: INSETS.top}]}>
      <XFlatList
        ...
        ListHeaderComponent={() => (
          <XText style={styles.header} text={headerText} />
        )}
